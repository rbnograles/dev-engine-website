            ...
            <Row>
              ...
              >
                <img
                  ...
                  className="testimonila-image"
                />
                <p className="name">
                  Arthur - School Administrator (Singapore)
                </p>
                <Card
                  aosclasses="fade-up"
                  aosDelay="300"
                  ...
                  message="Following the demo last March 2020, my school has begun working with Team devengine to integrate their Enrolment system into our school."
              ...
              >
                ...
                <Card
                  classNames="card-blog"
                  message="Since my school started adopting devengine, we went paperless and now I can access things from my phone really easily!"
                />
              </div>
            </Row>
          </div>
