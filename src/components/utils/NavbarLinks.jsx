...
export class NavbarLinks extends Component {
  render() {
    ...
    return (
      <Fragment>
        <ul
          className={`nav-list-display ${!isToggleOpen ? "w-close" : "w-open"}`}
        >
        ...
        <p className={`side-toggle-footer ${!isToggleOpen ? "close" : "open"}`}>
          Powered by <b>devengine</b> Technologies &copy; 2020
        </p>
      </Fragment>
    );
  }
